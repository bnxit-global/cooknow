    ...
    <div className="w-full relative">
      ...
      <div className="relative mb-6">
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div
            ref={dropdownRef}
            className="absolute top-full left-0 right-0 mt-2 bg-[#0c0a09] border border-gold/20 shadow-xl z-50 rounded-sm max-h-[240px] overflow-y-auto"
          >
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {ingredients.map((ing) => (
              ...
              >
                <span>{ing}</span>
                <span className="text-gold/40 hover:text-red-400 text-xs">
                  ✕
                </span>
              </button>
            ))}
