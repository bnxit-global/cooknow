...
export const MOCK_RECIPES: Recipe[] = [
  {
    ...
    description: 'A simple, filling egg fried rice made with minimal ingredients.',
    ...
    story: 'Made this at midnight with just rice, egg, and onion — simple, filling, and lifesaving.'
  },
  {
    id: '2',
    name: 'One-Pan Tomato Toast',
    description: 'Crispy bread topped with flavorful sautéed tomatoes.',
  ...
  },
  {
    ...
    story: 'A classic breakfast that never disappoints. Perfect for lazy mornings.'
  },
  {
    id: '4',
    name: 'Garlic Butter Noodles',
    description: 'Simple yet delicious buttery noodles with garlic.',
  ...
  },
  {
    ...
    description: 'A quick and healthy smoothie for any time.',
  ...
  },
  {
    ...
    description: 'Refreshing salad with chickpeas, lemon, and herbs.',
  ...
  },
  {
     ...
     description: 'A spicy and savory Korean classic.',
  ...
  },
  {
     ...
     description: 'A fresh, raw salsa perfect for dipping or topping.',
     ...
     cookingTime: '5 min',
     imageUrl: 'https://images.unsplash.com/photo-1541288097308-7b8e3f58c4c6?auto=format&fit=crop&q=80&w=800',
     story: 'Pure freshness in every bite.'
  },
  {
     id: '10',
     name: 'Universal Kitchen Fusion',
     description: 'A customizable base recipe that adapts to any ingredients.',
  ...
  },
  {
     ...
     description: 'A robust stew that harmonizes diverse global ingredients.',
...
export function findRecipes(userIngredients: string[]): Recipe[] {
  ...
  return matchingRecipes.length >= 2 ? matchingRecipes : matchingRecipes.concat(
    MOCK_RECIPES.filter(r => !matchingRecipes.includes(r)).slice(0, 2 - matchingRecipes.length)
  );
}
